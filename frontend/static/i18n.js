...
const I18n = (() => {
    ...
    const dict = {
        zh: {
            ...
            'composer.stop': '停止',
            'composer.drop.hint': '拖拽文件到这里 (图片 / 文档 / 任意文本文件)',
            'composer.attach.upload_image': '点击或拖拽文件',
            ...
            'toast.attach.unparseable': '无法解析此文件 (二进制或不支持的格式)',
        ...
        en: {
            ...
            'composer.stop': 'Stop',
            'composer.drop.hint': 'Drop files here (images / documents / any text file)',
            'composer.attach.upload_image': 'Click or drop files',
            ...
            'toast.attach.unparseable': 'Cannot parse this file (binary or unsupported format)',
