...
const I18n = (() => {
    ...
    const dict = {
        zh: {
            ...
            'toast.attach.invalid.body': '支持图片及 txt/pdf/docx/md/xlsx/ppt/csv/json 等文档',
        ...
        en: {
            ...
            'toast.attach.invalid.body': 'Images and documents (txt/pdf/docx/md/xlsx/ppt/csv/json...) are supported',
