...
[配置管理模块（config_module）设计文档](./基础支撑层-配置管理模块（config_module）设计文档.md)
#### 4.1.2.1 模块功能
...
[日志模块（log_module）设计文档](./基础支撑层-日志模块（log_module）设计文档.md)
#### 4.1.3.1 模块功能
...
[异常处理模块（exception_module）设计文档](./基础支撑层-异常处理模块（exception_module）设计文档.md)
#### 4.1.4.1 模块功能
