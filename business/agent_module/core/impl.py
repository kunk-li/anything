...
class SimpleAgent(
    ...
    # ============================================================
    # 方向4 自维护方法组已抽到 components/self_maintenance.py (SelfMaintenanceMixin, 优化③)。
    # 下面两个 helper 留在 impl: _resolve_project_root(__file__ 定位项目根, 位置相关)
    # 与 _extract_and_store_memory(记忆写入, execute 收尾调用, 属记忆而非维护)。
    # ============================================================
